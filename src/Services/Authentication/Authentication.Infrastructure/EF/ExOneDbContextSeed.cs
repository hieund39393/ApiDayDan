    ...
    public class ExOneDbContextSeed
    {
        public async Task SeedAsync(ExOneDbContext context, UserManager<User> userManager)
        {
            ...
            if (!context.Menu.Any())
            {
                ...
                listMenu.Add(new Menu { ParenId = new Guid("C09E6504B3DBC74180EB85C76EB222C4"), Id = new Guid("E17A625E0334C04D928300BBF8C83889"), Code = $"{Permissions.DonGiaVatLieuChietTinh}", Name = "Đơn giá vật liệu chiết tính", Url = "/don-gia-vat-lieu-chiet-tinh-cap-ngam", Order = 4, ModuleId = new Guid("C09E6504B3DBC74180EB85C76EB329C4") });
