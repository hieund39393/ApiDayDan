    ...
    public class ExOneDbContextSeed
    {
        public async Task SeedAsync(ExOneDbContext context, UserManager<User> userManager)
        {
            ...
            if (!context.Menu.Any())
            {
                ...
                listMenu.Add(new Menu { ParenId = new Guid("C09E6504B3DBC74180EB85C76EB111C4"), Id = new Guid("E17A625E0334C04D928300BBF8C10003"), Code = $"{Permissions.DonGiaMTCCapNgam}", Name = "Đơn giá máy thi công", Url = "/don-gia-may-thi-cong", Order = 3, ModuleId = new Guid("C09E6504B3DBC74180EB85C76EB329C4") });
                ...
                listMenu.Add(new Menu { ParenId = new Guid("C09E6504B3DBC74180EB85C76EB111C4"), Id = new Guid("E17A625E0334C04D928300BBF8C88100"), Code = $"{Permissions.CauHinhChietTinh}", Name = "Cấu hình chiết tính", Url = "/cau-hinh-chiet-tinh", Order = 4, ModuleId = new Guid("C09E6504B3DBC74180EB85C76EB329C4") });
                // cáp ngầm
                ...
                listMenu.Add(new Menu { ParenId = new Guid("C09E6504B3DBC74180EB85C76EB222C4"), Id = new Guid("E17A625E0334C04D928300BBF8C88101"), Code = $"{Permissions.CauHinhChietTinhCapNgam}", Name = "Cấu hình chiết tính", Url = "/cau-hinh-chiet-tinh-cap-ngam", Order = 4, ModuleId = new Guid("C09E6504B3DBC74180EB85C76EB329C4") });
