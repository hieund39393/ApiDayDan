...
namespace Authentication.Infrastructure.Migrations
{
    ...
    [Migration("20231103162241_Db_add_vanBanThongBao3")]
    partial class Db_add_vanBanThongBao3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Authentication.Infrastructure.AggregatesModel.ActionsAggregate.VanBanThongBao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Authentication.Infrastructure.AggregatesModel.BieuGiaTongHopAggregate.BieuGiaTongHopChiTiet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("BieuGiaTongHopChiTiet", (string)null);
                });

            modelBuilder.Entity("Authentication.Infrastructure.AggregatesModel.BieuGiaTongHopAggregate.BieuGiaTongHopChiTiet_CapNgam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("BieuGiaTongHopChiTiet_CapNgam", (string)null);
                });
            ...
            modelBuilder.Entity("Authentication.Infrastructure.AggregatesModel.DonGiaChietTinhAggregate.ChietTinhChiTiet_CapNgam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("ChietTinhChiTiet_CapNgam", (string)null);
                });
            ...
            modelBuilder.Entity("Authentication.Infrastructure.AggregatesModel.DonGiaChietTinhAggregate.ChietTinhChiTiet_CapNgam", b =>
                {
                    b.HasOne("Authentication.Infrastructure.AggregatesModel.DonGiaChietTinhAggregate.DonGiaChietTinh_CapNgam", "DonGiaChietTinh_CapNgam")
                        .WithMany("ChietTinhChiTiet_CapNgams")
                        .HasForeignKey("IdDonGiaChietTinh")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DonGiaChietTinh_CapNgam");
                });
            ...
            modelBuilder.Entity("Authentication.Infrastructure.AggregatesModel.DonGiaChietTinhAggregate.DonGiaChietTinh_CapNgam", b =>
                {
                    b.Navigation("ChietTinhChiTiet_CapNgams");
                });
