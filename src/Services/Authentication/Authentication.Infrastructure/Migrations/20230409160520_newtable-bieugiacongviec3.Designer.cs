...
namespace Authentication.Infrastructure.Migrations
{
    ...
    [Migration("20230409160520_newtable-bieugiacongviec3")]
    partial class newtablebieugiacongviec3
    {
            ...
            modelBuilder.Entity("Authentication.Infrastructure.AggregatesModel.ChiTietBieuGiaAggregate.ChiTietBieuGia", b =>
                {
                    ...
                    b.Property<Guid?>("DM_CongViecId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DM_KhuVucId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DM_VungId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DM_CongViecId");

                    b.HasIndex("DM_KhuVucId");

                    b.HasIndex("DM_VungId");
            ...
            modelBuilder.Entity("Authentication.Infrastructure.AggregatesModel.ChiTietBieuGiaAggregate.ChiTietBieuGia", b =>
                {
                    ...
                    b.HasOne("Authentication.Infrastructure.AggregatesModel.DM_CongViecAggregate.DM_CongViec", null)
                        .WithMany("ChiTietBieuGia")
                        .HasForeignKey("DM_CongViecId");

                    b.HasOne("Authentication.Infrastructure.AggregatesModel.DM_KhuVucAggregate.DM_KhuVuc", null)
                        .WithMany("ChiTietBieuGia")
                        .HasForeignKey("DM_KhuVucId");

                    b.HasOne("Authentication.Infrastructure.AggregatesModel.DM_VungAggregate.DM_Vung", null)
                        .WithMany("ChiTietBieuGia")
                        .HasForeignKey("DM_VungId");
