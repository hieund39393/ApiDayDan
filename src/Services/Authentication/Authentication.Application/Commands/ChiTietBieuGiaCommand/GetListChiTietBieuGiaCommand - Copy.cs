...
//{
//    public class GetListChiTietBieuGiaCommandss : IRequest<ChiTietBieuGiaResult>
//    {
...
//                    item.DonGia_VL = (item.DonGia_VL != 0 ? item.DonGia_VL : giaCap ?? 0) * item.HeSoDieuChinh_K1nc;
//                    item.DonGia_NC = (item?.DonGia_NC ?? 0) * item.HeSoDieuChinh_K2nc;
//                    item.DonGia_MTC = (item?.DonGia_MTC ?? 0) * item.HeSoDieuChinh_Kmtc;
//                }
...
//                    item.DonGia_VL = (item.DonGia_VL != 0 ? item.DonGia_VL : donGiaCT?.DonGiaVatLieu ?? 0) * item.HeSoDieuChinh_K1nc;
//                    item.DonGia_NC = (item.DonGia_NC != 0 ? item.DonGia_NC : donGiaCT?.DonGiaNhanCong ?? 0) * item.HeSoDieuChinh_K2nc;
//                    item.DonGia_MTC = (item.DonGia_MTC != 0 ? item.DonGia_MTC : donGiaCT?.DonGiaMTC ?? 0) * item.HeSoDieuChinh_Kmtc;
//                }
//                else
//                {
...
//                    item.DonGia_VL = (item.DonGia_VL != 0 ? item.DonGia_VL : vatLieu?.DonGia ?? 0) * item.HeSoDieuChinh_K1nc;
//                    item.DonGia_NC = (item.DonGia_NC != 0 ? item.DonGia_NC : item?.DonGia_NC ?? 0) * item.HeSoDieuChinh_K2nc;
//                    item.DonGia_MTC = (item.DonGia_MTC != 0 ? item.DonGia_MTC : item?.DonGia_MTC ?? 0) * item.HeSoDieuChinh_Kmtc;
//                }
